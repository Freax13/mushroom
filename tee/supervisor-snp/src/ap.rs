...
use constants::{ApIndex, AtomicApBitmap, MAX_APS_COUNT};
use snp_types::{
    intercept::{
...
fn emulate_cpuid(eax: u32, ecx: u32) -> (u32, u32, u32, u32) {
    ...
    match (eax, ecx) {
        ...
        (0x0000_0002..=0x0000_0004, _) => (0x00000000, 0x00000000, 0x00000000, 0x00000000),
        (0x0000_0005, _) => (0x00000040, 0x00000040, 0x00000003, 0x00000011),
        (0x0000_0006, _) => (0x00000004, 0x00000000, 0x00000001, 0x00000000),
        ...
        // This uses different values than natively returned by the CPU because
        // mushroom doesn't emulate hyperthreads.
        (0x0000_000b, 0) => (
            0x00000000,
            0x00000001,
            0x00000100,
            u32::from(PerCpu::get().vcpu_index.as_u8()),
        ),
        (0x0000_000b, 1) => (
            MAX_APS_COUNT.next_power_of_two().ilog2(),
            u32::from(MAX_APS_COUNT),
            0x00000201,
            u32::from(PerCpu::get().vcpu_index.as_u8()),
        ),
        (0x0000_000b, n) => (
        ...
        (0x0000_000c, _) => (0x00000000, 0x00000000, 0x00000000, 0x00000000),
        ...
        (0x0000_000e, _) => (0x00000000, 0x00000000, 0x00000000, 0x00000000),
        (0x0000_000f, 0) => (0x00000000, 0x000000ff, 0x00000000, 0x00000002),
        (0x0000_000f, 1) => (0x00000000, 0x00000040, 0x000000ff, 0x00000007),
        (0x0000_000f, _) => (0x00000000, 0x00000000, 0x00000000, 0x00000000),
        (0x0000_0010, 0) => (0x00000000, 0x00000002, 0x00000000, 0x00000000),
        (0x0000_0010, 1) => (0x0000000f, 0x00000000, 0x00000004, 0x0000000f),
        (0x0000_0010, _) => (0x00000000, 0x00000000, 0x00000000, 0x00000000),
        ...
        (0x8000_0002, _) => (0x20444d41, 0x43595045, 0x31373720, 0x34362033),
        (0x8000_0003, _) => (0x726f432d, 0x72502065, 0x7365636f, 0x20726f73),
        (0x8000_0004, _) => (0x20202020, 0x20202020, 0x20202020, 0x00202020),
        (0x8000_0005, _) => (0xff40ff40, 0xff40ff40, 0x20080140, 0x20080140),
        (0x8000_0006, _) => (0x48002200, 0x68004200, 0x02006140, 0x00809140),
        (0x8000_0007, _) => (0x00000000, 0x0000003b, 0x00000000, 0x00006799),
        (0x8000_0008, _) => (0x00003030, 0x91bef75f, 0x0000707f, 0x00010007),
        (0x8000_0009, _) => (0x00000000, 0x00000000, 0x00000000, 0x00000000),
        (0x8000_000a, _) => (0x00000001, 0x00008000, 0x00000000, 0x119b9cff),
        (0x8000_000b..=0x8000_0018, _) => (0x00000000, 0x00000000, 0x00000000, 0x00000000),
        (0x8000_0019, _) => (0xf040f040, 0xf0400000, 0x00000000, 0x00000000),
        (0x8000_001a, _) => (0x00000006, 0x00000000, 0x00000000, 0x00000000),
        (0x8000_001b, _) => (0x000003ff, 0x00000000, 0x00000000, 0x00000000),
        (0x8000_001c, _) => (0x00000000, 0x00000000, 0x00000000, 0x00000000),
        (0x8000_001d, 0) => (0x00004121, 0x01c0003f, 0x0000003f, 0x00000000),
        (0x8000_001d, 1) => (0x00004122, 0x01c0003f, 0x0000003f, 0x00000000),
        (0x8000_001d, 2) => (0x00004143, 0x01c0003f, 0x000003ff, 0x00000002),
        (0x8000_001d, 3) => (0x0003c163, 0x03c0003f, 0x00007fff, 0x00000001),
        (0x8000_001d, _) => (0x00000000, 0x00000000, 0x00000000, 0x00000000),
        // This uses different values than natively returned by the CPU because
        // mushroom doesn't emulate hyperthreads.
        (0x8000_001e, _) => (
            u32::from(PerCpu::get().vcpu_index.as_u8()),
        ...
        (0x8000_001f, _) => (0x0101fd3f, 0x00004173, 0x000001fd, 0x000001fd),
        (0x8000_0020, 0) => (0x00000000, 0x00000002, 0x00000000, 0x00000000),
        (0x8000_0020, 1) => (0x0000000b, 0x00000000, 0x00000000, 0x0000000f),
        (0x8000_0020, _) => (0x00000000, 0x00000000, 0x00000000, 0x00000000),
        (0x8000_0021, _) => (0x0000204d, 0x00000000, 0x00000000, 0x00000000),
        (0x8000_0022, _) => (0x00000000, 0x00000000, 0x00000000, 0x00000000),
        (0x8000_0023, _) => (0x00000000, 0x00000000, 0x00000000, 0x00000000),
