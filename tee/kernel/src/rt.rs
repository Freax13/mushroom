...
use crate::{
    exception::DisableAllInterruptsGuard, per_cpu::PerCpu, spin::mutex::Mutex, time,
    user::schedule_vcpu,
};
...
static SCHEDULED_THREADS: Mutex<XorLinkedList<TaskAdapter>, DisableAllInterruptsGuard> =
