...
impl PageInfo {
    ...
    fn linux_vmsa(digest_cur: [u8; 48]) -> Self {
        const VMSA_CONTENT: [u8; 48] = [
            0xeb, 0x6e, 0xdc, 0x84, 0x03, 0x2f, 0x3b, 0x9c, 0x0e, 0xfe, 0xa7, 0xb9, 0x80, 0x8f,
            0x5c, 0x5f, 0xc1, 0xfd, 0xc2, 0x7c, 0xd8, 0xe1, 0x96, 0xa7, 0xc0, 0xd4, 0xaa, 0x25,
            0x03, 0x44, 0x6e, 0xcb, 0x74, 0x19, 0xaf, 0x4c, 0x46, 0xf2, 0x36, 0x41, 0x8d, 0xe9,
            0xc4, 0xb7, 0x39, 0xc7, 0x79, 0xbb,
        ];
